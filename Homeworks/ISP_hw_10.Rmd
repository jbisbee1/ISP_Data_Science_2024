...
dat <- read_rds(file="https://github.com/jbisbee1/ISP_Data_Science_2024/raw/main/data/FloridaCountyData.Rds")
glimpse(dat)
```
...
```{r}
dat.all <- read_rds(file="https://github.com/jbisbee1/ISP_Data_Science_2024/raw/main/data/CountyVote2004_2020.Rds")
