...
title: "Problem Set 4"
author: "[YOUR NAME]"
date: "Due Date: 2024-07-19 by 11:59PM"
output:
...
You are free to rely on whatever resources you need to complete this problem set, including lecture notes, lecture presentations, Google, your classmates...you name it. However, the final submission must be complete by you. There are no group assignments. To submit, post the knitted output to eTL website (pset 4 assignment) by 11:59PM on Friday, July 19th. If you need help converting to a PDF, see [this tutorial](https://github.com/jbisbee1/ISP_Data_Science_2024/blob/main/Psets/ISP_pset_0_HELPER.pdf).
...
## Question 6 [2 points + 1 EC point]
