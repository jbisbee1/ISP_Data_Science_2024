...
--
  ...
  - Download and open [`Pres2020_PV.Rds`](https://github.com/jbisbee1/ISP_Data_Science_2024/blob/main/data/Pres2020_PV.Rds)
...
require(tidyverse)
poll <- read_rds('https://github.com/jbisbee1/ISP_Data_Science_2024/raw/main/data/Pres2020_PV.Rds')
...
- Load [`Pres2020_StatePolls.Rds`](https://github.com/jbisbee1/ISP_Data_Science_2024/blob/main/data/Pres2020_StatePolls.Rds) to `statePoll` object

```{r,message = F,warning=F}
require(tidyverse)
statePoll <- read_rds('https://github.com/jbisbee1/ISP_Data_Science_2024/raw/main/data/Pres2020_StatePolls.Rds')
```
