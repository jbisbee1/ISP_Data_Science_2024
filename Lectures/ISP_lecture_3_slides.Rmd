...
set.seed(123)
options(width=60)
knitr::opts_chunk$set(fig.align='center',fig.width=9,fig.height=5,error=TRUE,dev = 'svg')
...
- Download [`MI2020_ExitPoll.rds`](https://github.com/jbisbee1/ISP_Data_Science_2024/blob/master/data/MI2020_ExitPoll.rds) to your `data` folder
